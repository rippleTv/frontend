		...
		return (
			<div style={{ width: '100%' }}>
				{this.state.display == true && (
					<NavPop giveClass="navsidepop" handleClick={this.handleHamburger} />
				)}
				<nav className={`${this.props.giveClass} generic--navbar`}>
					<img src={logo} alt="ripple-logo" />
					<div className="nav--items">
						<div className="nav--item">
							<NavLink to="/home" activeClassName="active--nav__item">
								Home
							</NavLink>
						</div>
						<div className="nav--item">
							<NavLink to="/movies" activeClassName="active--nav__item">
								Movies
							</NavLink>
						</div>
						<div className="nav--item">
							<NavLink to="/series" activeClassName="active--nav__item">
								Series
							</NavLink>
						</div>
						<div className="nav--item">
							<NavLink to="/lists" activeClassName="active--nav__item">
								My List
							</NavLink>
						</div>
					</div>
				...
				{this.state.displayDrop && (
					...
					>
						<div onClick={() => this.props.history.push(ROUTES.USER)}>
							Account
						</div>
