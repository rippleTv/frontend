                ...
                <div className="seriespage--middle">
                    <div className="seriespage--middle__titles">
                        ...
                        <div className="seriespage--drops">
                            Drama <i onClick={() => this.handleDrop("genre")} className="fas fa-chevron-down"></i>
                        </div>
                    </div>
                    {this.state.displayGenre && <DropDown giveClass="genre--dropdown" contents={["Drama", "Comedy", "Thriller"]}/>}
                    <div className="seriespage--middle__titles">
                        <h3>Release Date</h3>
                        <div className="seriespage--drops">
                            2019 <i onClick={() => this.handleDrop("date")} className="fas fa-chevron-down"></i>
                        </div>
                        
                    </div>
                    
                    {this.state.displayDate && <DropDown giveClass="date--dropdown" contents={["2019", "2018", "2017"]}/>}
                    
                    <div className="seriespage--middle__titles">
                        <h3>Quality</h3>
                        <div className="seriespage--drops">
                            HD <i onClick={() => this.handleDrop("quality")} className="fas fa-chevron-down"></i>
                        </div>
                    </div>

                    {this.state.displayQuality && <DropDown giveClass="quality--dropdown" contents={["HD", "Webp", "Avi"]}/>}
